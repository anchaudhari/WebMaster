...
MODEL_ENGINE_NAME = "gemini-2.5-flash"  # 100% Optimized for Gemini 2.5
# -----------------------------------------------------------------------------
...
# 5. REST API Engine (બધી જ 401 અને કનેક્શન એરર્સ ફિક્સ કરતું લોજિક)
def build_application_backend(prompt, api_key):
    ...
    # સત્તાવાર ગૂગલ REST endpoint URL
...
# 6. Advanced Smart Parser (કોડ એક્સટ્રેક્ટર)
...
with left_console:
    ...
    # બિલકુલ તમારું માગેલું "give here your mind thought" પ્લેસહોલ્ડર વાળું બોક્સ
